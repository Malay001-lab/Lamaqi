...
const Header = () => {
  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50 transition-all duration-300">
      <div className="container mx-auto container-custom py-3 px-4 sm:px-6 lg:px-8">
        ...
        {open && (
          <div className="md:hidden mt-3">
            <nav className="bg-white rounded-lg shadow-md border border-gray-100 p-4 space-y-3">
              {navItems.map((item) => (
                <Link
                  key={item.name}
                  to={item.href}
              ...
              <div className="pt-2 border-t border-gray-100 mt-2 flex space-x-3">
                <a
